...
--
-- Hôte : localhost
-- Généré le :  mar. 09 mars 2021 à 02:57
...
INSERT INTO `editeur` (`id`, `nom`, `information`) VALUES
(1, 'Éditions Emmanuelle Collas', 'Aucune information supplémentaire'),
...
(3, 'Seuil', 'Créées par Henri Sjöberg en 1935, les Éditions du Seuil font partie des plus grandes maisons d`éditions françaises et sont présentes dans tous les domaines éditoriaux : littératures française et étrangère, thrillers et policiers, sciences humaines, documents, spiritualités, sciences, jeunesse et beaux-livres.'),
...
INSERT INTO `livre` (`id`, `titre`, `nb_pages`, `rating`, `resumer`, `editeur_id`, `date_edition`) VALUES
