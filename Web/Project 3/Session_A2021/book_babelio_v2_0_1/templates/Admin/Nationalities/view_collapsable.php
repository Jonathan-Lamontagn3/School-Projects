...
<li><?= $this->Html->link(__('New Continent'), ['controller' => 'Continents', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Html->link(__('Edit'), ['controller' => 'Authors', 'action' => 'edit', $authors->id], ['class' => 'btn btn-secondary']) ?>
                        <?= $this->Form->postLink( __('Delete'), ['controller' => 'Authors', 'action' => 'delete', $authors->id], ['confirm' => __('Are you sure you want to delete # {0}?', $authors->id), 'class' => 'btn btn-danger']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
