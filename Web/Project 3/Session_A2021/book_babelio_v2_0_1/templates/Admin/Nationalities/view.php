...
<li><?= $this->Html->link(__('Edit Nationality'), ['action' => 'edit', $nationality->id], ['class' => 'nav-link']) ?></li>
<li><?= $this->Form->postLink(__('Delete Nationality'), ['action' => 'delete', $nationality->id], ['confirm' => __('Are you sure you want to delete # {0}?', $nationality->id), 'class' => 'nav-link']) ?></li>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['prefix' => false,'controller' => 'Authors', 'action' => 'view', $authors->id], ['class' => 'btn btn-secondary']) ?>
                        <?= $this->Html->link(__('Edit'), ['prefix' => false,'controller' => 'Authors', 'action' => 'edit', $authors->id], ['class' => 'btn btn-secondary']) ?>
                        <?= $this->Form->postLink( __('Delete'), ['prefix' => false,'controller' => 'Authors', 'action' => 'delete', $authors->id], ['confirm' => __('Are you sure you want to delete # {0}?', $authors->id), 'class' => 'btn btn-danger']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
