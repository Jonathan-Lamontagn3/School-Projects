        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $author->has('continent') ? $this->Html->link($author->continent->name, ['controller' => 'Continents', 'action' => 'view', $author->continent->id]) : '' ?></td>
                    <td><?= $author->has('nationality') ? $this->Html->link($author->nationality->name, ['controller' => 'Nationalities', 'action' => 'view', $author->nationality->id]) : '' ?></td>
                    <td><?= h($author->name) ?></td>
                    <td class="actions">
