    ...
    <body>
        <nav class="top-bar expanded" data-topbar role="navigation">
            <ul class="title-area large-3 medium-4 columns">
                <li class="name">
                    <h1><?= $this->Html->link(__('Babelio Books'), '/'); ?><?php // echo " - " . $this->fetch('title');            ?></h1>
                </li>
            </ul>
            <div class="top-bar-section">

                <ul class="right">
                    <li><?= $this->Html->link(__('Listes liées'), ['controller' => 'Authors', 'action' => 'add']) ?></li>
                    <li><?= $this->Html->link(__('Autocomplétion'), ['controller' => 'Books', 'action' => 'add']) ?></li>
                    <li><?= $this->Html->link(__('Monopage'), ['controller' => 'Tags', 'action' => 'index']) ?></li>
                    <li><?= $this->Html->link(__('Drag and Drop'), ['controller' => 'Files', 'action' => 'index']) ?></li>
                    <li><?= $this->Html->link(__('Admin demo'), ['prefix' => false, 'controller' => 'Nationalities', 'action' => 'index']) ?></li>
                    <li><?= $this->Html->link('A propos', ['controller' => 'Apropos', 'action' => 'index']) ?></li> 
                    <?php
