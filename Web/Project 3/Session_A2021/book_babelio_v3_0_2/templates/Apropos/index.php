...
<ul>
    <li>
        La page des liste liée du controleur Autheur fonctionne maintenant avec l'interface Angular JS.
    </li>
    <li>
        La monopage "CRUD" sur le controleur Tag fonctionne egalement avec cette interface.
    </li>
    <li>
        Il est possible d'y accèder a l'aide des liens dans la barre du menu.
    </li>     
</ul><br/>

<h4>Connexion par Token</h4>
<ul>
    <li>
        Il est maintenant impossible de ce connecter normalement.
    </li>
    <li>
        Pour ce connecter il faut accèder à la monopage et entrer nos information de compte.
    </li>
    <li>
        Une fois nos information bien entrées, il ne faut pas oublier de cocher le Captcha sinon aucun token ne sera envoyer.
    </li>     
</ul><br/>

<h4>Ajout d'image par cliquer-glisser</h4>
<ul>
    <li>
        Il est maintenant impossible d'ajout nos image lors de la création/modification d'un livre.
    </li>
    <li>
        Pour ajouter une image à notre livre il faut d'abord mettre l'image dans la base de donnée.
    </li>
    <li>
        Pour ajouter notre image il faut d'abord accèder a l'index de file en cliquant sur le lien "Drag and Drop" dans le menu.
    </li> 
    <li>
        Une fois l'image ajouter, en la glissant dans l'index, il suffit de la liée a notre livre en cliquant sur modifiée.
    </li>    
</ul><br/>
...
<div> 
    ...
    <div><?= @$this->Html->image('apropos/bd_book_babelio_phpmyadmin.PNG', ['style' => 'margin-right: auto; margin-left: auto; display: block;']) ?></div>
</div>
<br/>
<div>  
