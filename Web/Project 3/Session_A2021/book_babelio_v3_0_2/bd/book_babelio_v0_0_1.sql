...
--
-- Hôte : localhost
-- Généré le :  lun. 27 déc. 2021 à 01:55
...
--
-- Structure de la table `books_files`
--
...
--
-- Déchargement des données de la table `books_files`
--

INSERT INTO `books_files` (`id`, `book_id`, `file_id`) VALUES
(1, 1, 2);
...
(1, 'achilles_battleworn.jpg', 'books/', '2021-12-25 21:43:52', '2021-12-25 21:43:52', 1),
(2, '01_Banner_State_Of_Skins_Kindred_Splash.jpg', 'books/', '2021-12-25 21:49:21', '2021-12-25 21:56:45', 1);
...
(1, 'adf2908f-dfa3-4763-a7da-9b3b7d104a18', 1, 'Jonathan', 'Joe@gmail.com', 1, '$2y$10$lGQvT.6I/4.0Hze/qS5jtunN2FHAHYFebIg0mH.VdQQ8QnGCUjOC2', '2021-09-20 19:28:31', '2021-12-24 03:26:08'),
...
(10, '36bc7754-f62e-400e-a8cb-b6f1a0b7d42c', 1, 'Momo', 'momo@gmail.com', 1, '$2y$10$zb77lztLYlxdzXwPa4/kQeCEoF4Ve8SK4BgYmdxEzHaIf6hNdxFe2', '2021-12-23 18:07:58', '2021-12-23 18:07:58'),
(11, '5c416970-c86c-4a1a-8011-71cb6988e580', 1, 'jotest', 'jotest@gmail.com', 1, '$2y$10$sJN/fD9ZkwL.G5B4nGottO0QOZWPTh8VH50r6HK5JSJL/UU6XX5Na', '2021-12-23 18:42:33', '2021-12-23 18:42:33');
...
--
-- Index pour la table `books_files`
--
ALTER TABLE `books_files`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_book_book_id3` (`book_id`),
  ADD KEY `fk_file_file_id` (`file_id`);
...
--
-- AUTO_INCREMENT pour la table `books_files`
--
ALTER TABLE `books_files`
...
--
-- Contraintes pour la table `books_files`
--
ALTER TABLE `books_files`
  ADD CONSTRAINT `fk_book_book_id3` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_file_file_id` FOREIGN KEY (`file_id`) REFERENCES `files` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
